...
class User {
    ...
    constructor(config) {
        ...
        this.id = '';
        __classPrivateFieldSet(this, _User_configuration, (0, apiConfiguration_1.default)({
            accessToken: __classPrivateFieldGet(this, _User_apiKey, "f"),
        }), "f");
        __classPrivateFieldSet(this, _User_client, new generated_1.UsersApi(__classPrivateFieldGet(this, _User_configuration, "f")), "f");
    }
    /**
    ...
    listDevices(userID) {
        return __awaiter(this, void 0, void 0, function* () {
            this._apiKeyCheck();
            try {
                const client = new generated_1.UserDevicesApi(__classPrivateFieldGet(this, _User_configuration, "f"));
    ...
    signOut(userID) {
        return __awaiter(this, void 0, void 0, function* () {
            this._apiKeyCheck();
            try {
                const client = new generated_1.TokensApi(__classPrivateFieldGet(this, _User_configuration, "f"));
